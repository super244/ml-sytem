...
c = c.replace("const availablePromptPresets = promptPresets.length\n    ? promptPresets\n    : demoMode\n      ? FALLBACK_PROMPTS\n      : [];", "const availablePromptPresets = useMemo(() => promptPresets.length\n    ? promptPresets\n    : demoMode\n      ? FALLBACK_PROMPTS\n      : [], [promptPresets, demoMode]);")

c = c.replace("import { useEffect, useRef, useState, useTransition } from 'react';", "import { useEffect, useRef, useState, useTransition, useMemo } from 'react';")
