...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate publication-style training-run visualization PNGs."
    )
    ...
    cmap_blue = LinearSegmentedColormap.from_list(
        "custom_blue", ["#f0f9ff", "#c9e8ff", "#7ec8e3", "#1f77b4", "#0a4a6e"]
    )
    cmap_orange = LinearSegmentedColormap.from_list(
        "custom_orange", ["#fff7ed", "#fed7aa", "#f97316", "#ea580c", "#9a3412"]
    )
    cmap_green = LinearSegmentedColormap.from_list(
        "custom_green", ["#f0fdf4", "#86efac", "#22c55e", "#16a34a", "#14532d"]
    )
    ...
    print("Generating ultra-advanced graphs...")

    _generate_ultra_figures(
        dataset_data,
        model_data,
        final_metrics,
        df,
...
def _generate_ultra_figures(
    ...
    accuracy_pct: float,
    cmap_blue: LinearSegmentedColormap,
    cmap_orange: LinearSegmentedColormap,
    cmap_green: LinearSegmentedColormap,
    output_dir: Path,
) -> None:
