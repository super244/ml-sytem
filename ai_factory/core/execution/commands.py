...
__all__ = ["UnsupportedInstanceTypeError", "build_command"]


def build_command(config: OrchestrationConfig, manifest: InstanceManifest, *, plugin_registry=None) -> CommandSpec:
