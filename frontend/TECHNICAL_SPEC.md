...
LearningMode: "supervised" | "unsupervised" | "rlhf" | "dpo" | "orpo" | "ppo" | "lora" | "qlora" | "full_finetune"
DeploymentTarget: "huggingface" | "ollama" | "lmstudio" | "api" | "openai_compatible_api" | "custom_api"
