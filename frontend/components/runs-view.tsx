          ...
          <article className="panel catalog-panel">
            <div className="message-meta">
              ...
              <span className="status-pill">
                {openCircuits.length ? `${openCircuits.length} open circuits` : "all circuits healthy"}
              </span>
            </div>
                ...
                <article key={instance.id} className="panel catalog-panel">
                  ...
                  <div className="preview-block subtle">
                    ...
                    <p>
                      ...
                      {instance.parent_instance_id ? ` • child of ${instance.parent_instance_id}` : ""}
                    </p>
                  </div>
                  <div className="badge-row">
                    <MetricBadge
                    ...
                    <MetricBadge
                      label="Accuracy"
                      value={formatPercent(numericMetric(instance.metrics_summary, ["accuracy"]), 1)}
                      tone="secondary"
                    />
                    <MetricBadge
                      label="Latency"
              ...
              {orchestrationRuns.slice(0, 8).map((run) => (
                <article key={run.id} className="panel catalog-panel">
                  ...
                  <div className="badge-row">
                    ...
                    <MetricBadge label="Updated" value={formatTimestamp(run.updated_at)} tone="secondary" />
                  </div>
                </article>
              ))}
            </div>
