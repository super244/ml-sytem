...
export function StatePanel({
  ...
  const baseClasses = "flex flex-col gap-4 p-8 rounded-3xl border backdrop-blur-xl shadow-sm transition-all duration-300";
  ...
  return (
    <section className={`${baseClasses} ${toneClasses}`}>
      <div className="flex flex-col items-start gap-3">
        <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase border ${eyebrowClasses}`}>
          {eyebrow}
        </div>
